...
class _ModernApplicationCardState extends State<ModernApplicationCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarImageCacheSize = (44 * MediaQuery.of(context).devicePixelRatio)
        .round();
    final shadowBlurRadius = effectiveHovered ? 8.0 : 2.0;
    final shadowOffsetY = effectiveHovered ? 4.0 : 1.0;
          ...
          child: AnimatedContainer(
            ...
            child: Stack(
              children: [
                ...
                if (widget.statusBadge != null)
                  Positioned(top: 12, right: 12, child: widget.statusBadge!),
              ],
            ),
          ),
        ),
