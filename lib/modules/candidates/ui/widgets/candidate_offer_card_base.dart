...
class _CandidateOfferCardBaseState extends State<CandidateOfferCardBase> {
  ...
  Widget build(BuildContext context) {
    ...
    final hoverOverlayGradient =
        CandidateOfferCardLogic.resolveHoverOverlayGradient(isDark: isDark);
              ...
              Positioned.fill(
                child: IgnorePointer(
                  child: AnimatedOpacity(
                    ...
                    child: DecoratedBox(
                      decoration: BoxDecoration(gradient: hoverOverlayGradient),
                    ),
                  ),
                ),
              ),
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        ...metrics.map(
                          (metric) => CandidateOfferMetricPill(metric: metric),
                        ),
                      ],
                    ),
                  ],
