    ...
    try {
      ...
      if (role === "candidate" && !candidateDoc.exists) {
        ...
        const companyProfile = {
          ...
          headquarters: "",
          description: "",
          multiposting_channel_settings: {
            enabledChannels: ["linkedin", "indeed", "university_portal"],
          },
          compliance_settings: {
            ...
            ai_consent_text_version: "2026.04",
            ai_consent_text:
              "Autorizo el uso de sistemas de IA para test y entrevistas de esta candidatura. Entiendo que puedo solicitar revisión humana y revocar en el portal de privacidad.",
          },
          id: Math.floor(Math.random() * 1000000),
          created_at: now,
          updated_at: now,
